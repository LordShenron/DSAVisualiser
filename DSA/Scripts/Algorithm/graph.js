...
$("#graphinput").val("")
  ...
  $(document).ajaxStart(  function()  {
    ...
    $("body").append(`<img style="position: fixed;top: 50%;left: 50%;transform: translate(-50%,-50%) ;z-index: 20; height:40%;" id="loaderx" src="/home/shen/Desktop/DSA-Visualizer/DSA/images/loader-3.gif">`)
...
Output("Graph saved successfully")
  ...
  window.onload = async function()  {
      document.body.insertAdjacentHTML("beforeend" , `<img id = "animationplay" src="/home/shen/Desktop/DSA-Visualizer/DSA/images/loader-3.gif"  style= "position:fixed; top:50%;left:50%;transform:translate(-50%,-50%);z-index:-1"/>`);

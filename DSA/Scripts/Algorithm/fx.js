...
document.body.insertAdjacentHTML("beforeend",`<img id = "skip-btn" src="/home/shen/Desktop/DSA-Visualizer/DSA/images/teleport_skip.png"  style= "position:fixed; right:290px;top: 240px;width: 60px; border-radius: 100%;z-index:5;"/>`)
...
function treefy(first,second ,color_ = "#8ab6d6" , _t ="") {
...
codehere.addEventListener("keypress" , async function(e)  {
  ...
  if (e.key == "Enter") {
    ...
    document.body.insertAdjacentHTML("beforeend" , `<a id = "animationplay"  style= "position:fixed; right:300px;bottom: 50px;width: 200px;z-index:-1"/>`)
...
Log("<span style='font-size:120%;color:#8ab6d6;'>Click arrow on the left side to open Codes list.</span>")
